...
- source_decisions: VER-20260808-002, VER-20260811-002, VER-20260816-002, VER-20260816-005, VER-20260903-002, VER-20260903-003, VER-20260903-004, VER-20260904-001, VER-20260904-003
...
- 代码锚点的符号核查只是子串查找（`path#symbol` 的 symbol 在文件文本中出现即算存在），不解析语法；`after_commit` 写成 `pr:` / `release:` 等非 SHA 形式时不校验、只提示"未关联 Git commit"；规则正文里裸写的 `<meta>` 之类仍按模板占位符处理，须加反引号（VER-20260904-003）
